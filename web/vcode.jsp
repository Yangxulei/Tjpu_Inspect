<%@ page language="java" import="java.util.*" import="java.awt.image.BufferedImage" pageEncoding="UTF-8" errorPage="error.jsp"%>
<--%
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li><a data-toggle="dropdown" class="dropdown-toggle"
                           href="#"> <img id="photo2" class="admin-pic img-circle"
                                          src="images/tuzi.png">你好，<%=session.getAttribute("uname")%><b
                            class="caret"></b>
                    </a>
